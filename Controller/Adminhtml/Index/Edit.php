...
namespace Koian\Banner\Controller\Adminhtml\Index;
...
class Edit extends \Magento\Backend\App\Action
{
     ...
     */
    const ADMIN_RESOURCE = 'Koian_Banner::save';
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Koian_Banner::banner');
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Koian\Banner\Model\Banner');
